...
const coffeeProviderSchema: mongoose.Schema = new mongoose.Schema(
  {
    ...
    community: (mongoose.Schema as any).ObjectId,
    active: {
      type: Boolean,
      default: true,
      select: false
...
// coffeeProviderSchema.pre(/^find/, function (next) {
//   // this points to the current query
//   (this as any).populate('community');
//   next();
// });

// coffeeProviderSchema.virtual('community', {
//   ref: 'Community',
...
const CoffeeProvider = mongoose.model('CoffeeProvider', coffeeProviderSchema);
